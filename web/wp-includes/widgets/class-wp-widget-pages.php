...
class WP_Widget_Pages extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		$sortby  = empty( $instance['sortby'] ) ? 'post_title' : $instance['sortby'];
		...
		$out = wp_list_pages(
			 ...
			 * @see wp_list_pages()
			 *
			 * @param array $args     An array of arguments to retrieve the pages.
	 ...
	 * @since 2.8.0
	 *
	 * @param array $new_instance New settings for this instance as input via the admin form.
